...
function convert(jdlEntities, creationTimestamp) {
  ...
  return getBasicEntityInformationFromEntities(jdlEntities, creationTimestamp || new Date());
}

function getBasicEntityInformationFromEntities(jdlEntities, creationTimestamp) {
