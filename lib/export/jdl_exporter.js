 ...
 * @return true if this option can be written in the jdl, false otherwise
 */
 ...
 * @param application JDLApplication
 * @return JDLApplication containing valid options for the jdl file
 */
...
/**
 * Add the entity names used by the application (in order to print the entity used by the application in the jdl)
 * @param jdlEntities JDLEntities containing the entities used by the application
 * @param jdlApplication JDLApplication
 * @return JDLApplication with the name of entities used by the application
 */
...
/**
 * Load a jhipster configuration with the entities into a JDLObject, it aggregates all the applications (if more than one) into one JDLObject
 * @param dir root folder
 * @return JDLObject representing the mono/multi applications containing the applications configurations and all entities used
 */
 ...
 * @return Object containing the JDLApplication and the JDLEntities of the jhipster application found in the directory
 */
 ...
 * @return names of sub directories containing a .yo-rc.json
 */
