...
const KEYWORD = chevrotain.createToken({
  name: 'KEYWORD', pattern: Lexer.NA, longer_alt: NAME, categories: NAME
});
...
createToken({ name: 'MIN_MAX_KEYWORD', pattern: Lexer.NA, categories: KEYWORD });
createToken({ name: 'MINLENGTH', pattern: 'minlength', categories: tokens.MIN_MAX_KEYWORD });
createToken({ name: 'MAXLENGTH', pattern: 'maxlength', categories: tokens.MIN_MAX_KEYWORD });
createToken({ name: 'MINBYTES', pattern: 'minbytes', categories: tokens.MIN_MAX_KEYWORD });
createToken({ name: 'MAXBYTES', pattern: 'maxbytes', categories: tokens.MIN_MAX_KEYWORD });
createToken({ name: 'MAX', pattern: 'max', categories: tokens.MIN_MAX_KEYWORD });
createToken({ name: 'MIN', pattern: 'min', categories: tokens.MIN_MAX_KEYWORD });
