...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c35 = function(com, f, t, com2, fdl) {return concat([{"name" : f, "type" : t, "validations" : [], "javadoc": com||com2}], fdl );},
        peg$c36 = function(com, f, t, vl, com2, fdl) {return concat([{"name" : f, "type" : t, "validations" : vl, "javadoc": com||com2}], fdl );},
        peg$c37 = function(com, f, t, vl, fdl) {return concat([{"name" : f, "type" : t, "validations" : vl, "javadoc": com}], fdl );},
        peg$c38 = function(v, vl) {return concat([v], vl);},
        peg$c39 = "relationship",
        peg$c40 = peg$literalExpectation("relationship", false),
        peg$c41 = function(rt, bodies) {
                addCardinalityToRelationships(rt, bodies);
                return concat([], bodies);
            },
        peg$c42 = function(rb, morerb) { return concat([rb], morerb); },
        peg$c43 = function(rb) { return [rb]; },
        peg$c44 = "to",
        peg$c45 = peg$literalExpectation("to", false),
        peg$c46 = function(from, to) {return {"from" : from , "to" : to};},
        peg$c47 = "required",
        peg$c48 = peg$literalExpectation("required", false),
        peg$c49 = function(jd, e, i, required) {return {"name" :e, "injectedfield" : i, "javadoc": jd, 'required': required ? true : false};},
        ...
        peg$c57 = "except",
        peg$c58 = peg$literalExpectation("except", false),
        peg$c59 = function(sub) {return sub;},
        peg$c60 = function(e, sub) {return concat([e], sub);},
        peg$c61 = "noFluentMethod for",
        peg$c62 = peg$literalExpectation("noFluentMethod for", false),
        ...
        peg$c138 = function(regexp) {return {key:'pattern' , value:regexp};},
        peg$c139 = peg$otherExpectation("apostrophe"),
        peg$c140 = /^["|']/,
        peg$c141 = peg$classExpectation(["\"", "|", "'"], false, false),
        peg$c142 = peg$otherExpectation("a regular expression"),
        peg$c143 = /^[a-zA-Z0-9!@#$%\^&*()_+\-=[\]{};':\\|,.<>\/? ]/,
        peg$c144 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "!", "@", "#", "$", "%", "^", "&", "*", "(", ")", "_", "+", "-", "=", "[", "]", "{", "}", ";", "'", ":", "\\", "|", ",", ".", "<", ">", "/", "?", " "], false, false),
        peg$c145 = function(word) {return makeString(word);},
        peg$c146 = peg$otherExpectation("an enum name"),
        peg$c147 = peg$otherExpectation("an enum property"),
        peg$c148 = /^[_]/,
        ...
        peg$c160 = function(negative, int) {return parseInt((negative ? negative : '') + int.join(""), 10);},
        peg$c161 = peg$otherExpectation("an injected field"),
        peg$c162 = /^[a-zA-Z]/,
        peg$c163 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false),
        peg$c164 = /^[a-zA-Z0-9()]/,
        peg$c165 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "(", ")"], false, false),
        peg$c166 = peg$otherExpectation("an entity name"),
        peg$c167 = peg$otherExpectation("a field name"),
        peg$c168 = peg$otherExpectation("a space"),
        peg$c169 = /^['\n'|'\t'|'\r'|' '|\u2028|\u2029]/,
                                      ...
                                      if (s16 !== peg$FAILED) {
                                        ...
                                        if (s17 !== peg$FAILED) {
                                          ...
                                          if (s18 !== peg$FAILED) {
                                            ...
                                            if (s19 !== peg$FAILED) {
                                              peg$savedPos = s0;
                                              s1 = peg$c36(s3, s7, s9, s11, s13, s19);
                                              s0 = s1;
                                            } else {
                                              peg$currPos = s0;
                                              s0 = peg$FAILED;
